...
See the [full onboarding guide][full onboarding guide](https://gentle-mermaid-e09396.netlify.app/#/onboarding) for environment variable setup, database configuration, and troubleshooting.
## Team — Code Cells
