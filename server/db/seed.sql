-- Insert a test user (for local dev testing)
...
-- Insert custom project fields (Text & Number)
...
VALUES
  ...
  ('d0eebc99-9c0b-4ef8-bb6d-6bb9bd380a44', 'b0eebc99-9c0b-4ef8-bb6d-6bb9bd380a22', 'Notes', 'text', 2, false)
ON CONFLICT DO NOTHING;
